      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="text-center" ref={heroRef}>
          ...
          <motion.p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed">
            Experience the future of car rental with Pick-Me-Up. Premium vehicles, 
            instant booking, and seamless service at your fingertips.
          </motion.p>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        >
          ...
          <Button
            onClick={handleGetStarted}
            size="lg"
            className="glass-button text-lg px-12 py-6 group"
          >
      ...
      <footer className="relative z-10 glass-card mx-4 mb-4 p-6">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-xl font-bold text-white">Pick-Me-Up</span>
          </div>
          <p className="text-white/60">
            © 2024 Pick-Me-Up. All rights reserved. | 
            <a
              href="https://vly.ai"
              target="_blank"
